...
var file_chat_service_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x00, 0x32, 0xeb, 0x01, 0x0a, 0x0b, 0x52, 0x61, 0x66, 0x74, 0x53, 0x65, 0x72, 0x76,
...
var file_chat_service_proto_goTypes = []interface{}{
	...
	(*AppendEntriesResponse)(nil), // 19: chat.AppendEntriesResponse
	(*RequestVoteResponse)(nil),   // 20: chat.RequestVoteResponse
	(*ForwardLeaderResponse)(nil), // 21: chat.ForwardLeaderResponse
}
var file_chat_service_proto_depIdxs = []int32{
	...
	1,  // 18: chat.ChatService.JoinGroupChat:output_type -> chat.GroupChatResponse
	3,  // 19: chat.ChatService.ServerView:output_type -> chat.ServerViewResponse
	5,  // 20: chat.AuthService.Login:output_type -> chat.LoginResponse
	7,  // 21: chat.AuthService.Logout:output_type -> chat.LogoutResponse
	19, // 22: chat.RaftService.AppendEntries:output_type -> chat.AppendEntriesResponse
	20, // 23: chat.RaftService.RequestVote:output_type -> chat.RequestVoteResponse
	21, // 24: chat.RaftService.ForwardLeader:output_type -> chat.ForwardLeaderResponse
